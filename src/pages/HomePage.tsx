...
const CARDS: CardDef[] = [
  { to: '/live',              Icon: LiveIcon,       title: 'Live',        desc: 'Real-time session data', sub: 'Sprint Qual · Sprint · Quali · Race' },
  ...
  { to: '/standings',         Icon: PodiumIcon,     title: 'Standings',   desc: 'Championship tables',    sub: 'Drivers · Constructors' },
  { to: '/sprint-qualifying', Icon: SprintQualIcon, title: 'Sprint Qual', desc: 'Sprint shootout',        sub: 'SQ1 · SQ2 · SQ3 segments' },
  { to: '/sprint',            Icon: SprintIcon,     title: 'Sprint',      desc: 'Sprint race results',    sub: 'Positions · Tyres · Pace' },
  { to: '/news',              Icon: NewsIcon,       title: 'News',        desc: 'Latest F1 headlines',    sub: 'Stories · Updates' },
];
          ...
          <Link key={card.to} to={card.to} style={{ textDecoration: 'none' }}>
            <div className="glass home-card" style={{ padding: 20, height: '100%', display: 'flex', flexDirection: 'column', gap: 4, transition: 'transform 0.15s, border-color 0.15s' }}>
              {card.img ? (
                ...
                <div className="home-card-icon" style={{ width: 96, height: 96, marginBottom: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#f8fafc' }}>
                  <card.Icon size={72} active={false} />
                </div>
              ) : null}
